...
package com.bandweaver.maxsec.NetVideo;
...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(System.getProperty("user.dir") + "\\src\\main\\resources\\hiklib\\HCNetSDK.dll",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
//智能设备类型
    ...
    public static final int NET_DVR_VIDEO_CALL_SIGNAL_PROCESS = 16032;  //可视话对讲信令处理
    /**********************设备类型 end***********************/
...
//NET_DVR_Login()参数结构
    ...
    */
    ...
    public static class NET_DVR_FACE_BUFFER extends Structure {
        public byte[] buffer;  //人脸数据
    }
...
//	public NET_ITC_REDLIGHT_PEDESTRIAN_PARAM struRedLightPed = new NET_ITC_REDLIGHT_PEDESTRIAN_PARAM();//行人闯红灯参数
    ...
    public enum NET_SDK_CALLBACK_TYPE {
        ...
        NET_SDK_CALLBACK_TYPE_PROGRESS(1),   //回调进度值
        NET_SDK_CALLBACK_TYPE_DATA(2);        //回调数据内容
         ...
         * 根据value值获取enum
         */
        public static NET_SDK_CALLBACK_TYPE getEnum(int value) {
            for (NET_SDK_CALLBACK_TYPE tmp : NET_SDK_CALLBACK_TYPE.values()) {
    ...
    public enum NET_SDK_CALLBACK_STATUS_NORMAL
    {
        ...
        NET_SDK_CALLBACK_STATUS_LANGUAGE_MISMATCH(1004),     //语言不匹配
        NET_SDK_CALLBACK_STATUS_DEV_TYPE_MISMATCH(1005),     //设备类型不匹配
        NET_DVR_CALLBACK_STATUS_SEND_WAIT(1006);             //发送等待

        @Getter
        private int value;

        NET_SDK_CALLBACK_STATUS_NORMAL(int value) {
            this.value = value;
        }
         ...
         * 根据value值获取enum
         */
        public static NET_SDK_CALLBACK_STATUS_NORMAL getEnum(int value) {
            for (NET_SDK_CALLBACK_STATUS_NORMAL tmp : NET_SDK_CALLBACK_STATUS_NORMAL.values()) {
                if (value == tmp.getValue())
                    return tmp;
            }
            return null;
