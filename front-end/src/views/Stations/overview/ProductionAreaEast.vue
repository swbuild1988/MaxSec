<template>
    <div class="production_area_east">
        <h4>{{ videoName }}</h4>
        <div id="OCXOverviewTopBody">
...
@Component({})
export default class ProductionAreaEast extends Vue {
    videoName: String = "";
    m_bDVRControl: any = "";
    ...
    getVideosInfo() {
        getVideoDtos().then((res: any) => {
            ...
            if (code != 200) {
                ...
                this.videoList = data;
                this.videoName = this.videoList[2].name;
                if (!this.videoList) {
                    return;
                }
                // 开始预览
                this.PreviewStart(this.videoList[2]);
            }
        });
    }
